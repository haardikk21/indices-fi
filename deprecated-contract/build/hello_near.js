...
let IndicesToken = (_dec = NearBindgen({
  ...
  ref_finance = "ref-finance.testnet";
  wrap_testnet = "wrap.testnet";
  banana_testnet = "banana.ft-fin.testnet";
  constructor() {
    super();
  }
  init({
  ...
  withdraw_from_exchange({
    ...
    const tokenOut = deserialize(promiseResult(0));
    const tokenToBeReturned = tokenOut - BigInt(1);
    const promise = NearPromise.new(this.ref_finance).functionCall("withdraw", serialize({
      token_id: address,
      amount: "1"
    }), ONE_YOCTO, FIVE_TGAS).then(NearPromise.new(this.ref_finance).functionCall("swap", bytes(JSON.stringify({
      actions: [{
        pool_id: poolId,
        token_in: address,
    ...
    })), ONE_YOCTO, FIVE_TGAS).then(NearPromise.new(this.ref_finance).functionCall("withdraw", serialize({
  ...
  buy_index_token({
    ...
    const promise = NearPromise.new(this.wrap_testnet).functionCall("near_deposit", bytes("{}"), BigInt(near_amounts[0]) - ONE_YOCTO - ONE_YOCTO, FIVE_TGAS).then(NearPromise.new(this.wrap_testnet).functionCall("storage_deposit", bytes(JSON.stringify({
      account_id: this.ref_finance
    })), STORAGE_DEPOSIT, FIVE_TGAS)).then(NearPromise.new(this.wrap_testnet).functionCall("ft_transfer_call", bytes(JSON.stringify({
      receiver_id: this.ref_finance,
      amount: (BigInt(near_amounts[0]) - ONE_YOCTO - ONE_YOCTO).toString(),
      msg: ""
    })), ONE_YOCTO, FIVE_TGAS)).then(NearPromise.new(swap_token_addresses[0]).functionCall("storage_deposit", bytes(JSON.stringify({
      account_id: this.ref_finance
    })), STORAGE_DEPOSIT, FIVE_TGAS)).then(NearPromise.new(this.ref_finance).functionCall("swap", bytes(JSON.stringify({
      actions: [{
        pool_id: pool_ids[0],
        token_in: this.wrap_testnet,
        amount_in: (BigInt(near_amounts[0]) - ONE_YOCTO - ONE_YOCTO).toString(),
        token_out: swap_token_addresses[0],
        min_amount_out: "1"
      }]
    })), ONE_YOCTO, FIVE_TGAS)).then(NearPromise.new(currentAccountId()).functionCall("withdraw_from_exchange", bytes(JSON.stringify({
      address: swap_token_addresses[0],
      poolId: pool_ids[0]
    })), NO_DEPOSIT, SEVEN_TEEN_TGAS));
    return promise.asReturn();
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "storage_deposit", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "storage_deposit"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "ft_transfer", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "ft_transfer"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "ft_transfer_call", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "ft_transfer_call"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "ft_total_supply", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "ft_total_supply"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "ft_balance_of", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "ft_balance_of"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "withdraw_from_exchange", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "withdraw_from_exchange"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "buy_index_token", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "buy_index_token"), _class2.prototype)), _class2)) || _class);

// User needs 1 banana and 1 USDC
// Frontend knows how much near we need
// User sent all NEAR
// Now upto us to figure out how much 1 banana and 1 USDC
function buy_index_token() {
  ...
  const _result = _contract.buy_index_token(_args);
...
export { IndicesToken, buy_index_token, ft_balance_of, ft_total_supply, ft_transfer, ft_transfer_call, init, storage_deposit, withdraw_from_exchange };
