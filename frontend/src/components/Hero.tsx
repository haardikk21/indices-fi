...
import logoNEAR from '@/images/logos/near.svg'
import logoTailwind from '@/images/logos/tailwind.svg'
import logoNext from '@/images/logos/next.svg'
import logoRefFinance from '@/images/logos/reffinance.svg'
  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Most index funds outperform managed funds over the long run. We make
        creating, investing, and trading index funds on NEAR easy.
      </p>
      ...
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-slate-900">
          Made possible thanks to various technologies
        </p>
        <ul
          role="list"
        ...
        >
          {[
            [
              { name: 'NEAR', logo: logoNEAR },
              { name: 'Rust', logo: logoRust },
              { name: 'Ref Finance', logo: logoRefFinance },
            ],
            [
